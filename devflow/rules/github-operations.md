...
Standard patterns for GitHub CLI operations across all DevFlow commands.
...
if [[ "$remote_url" == *"AI-LENS/Product-dev-system"* ]] || [[ "$remote_url" == *"AI-LENS/Product-dev-system.git"* ]]; then
  echo "❌ ERROR: You're trying to sync with the DevFlow template repository!"
  echo ""
  echo "This repository (AI-LENS/Product-dev-system) is a template for others to use."
